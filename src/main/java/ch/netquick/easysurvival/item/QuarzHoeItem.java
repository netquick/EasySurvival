...
public class QuarzHoeItem extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:quarz_hoe")
	public static final Item block = null;
	public QuarzHoeItem(EasysurvivalModElements instance) {
		super(instance, 41);
	}
