...
public class QuarzAxeItem extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:quarz_axe")
	public static final Item block = null;
	public QuarzAxeItem(EasysurvivalModElements instance) {
		super(instance, 38);
	}
