...
public class QuarzSwordItem extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:quarz_sword")
	public static final Item block = null;
	public QuarzSwordItem(EasysurvivalModElements instance) {
		super(instance, 39);
	}
