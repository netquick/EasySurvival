...
public class BasaltHoeItem extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:basalt_hoe")
	public static final Item block = null;
	public BasaltHoeItem(EasysurvivalModElements instance) {
		super(instance, 26);
	}
