...
import ch.netquick.easysurvival.gui.CropGUIGui;
import ch.netquick.easysurvival.EasysurvivalModElements;

@EasysurvivalModElements.ModElement.Tag
public class CropBlock extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:crop")
	public static final Block block = null;
	@ObjectHolder("easysurvival:crop")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CropBlock(EasysurvivalModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("crop"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Crop");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new CropGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new CropGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
