...
public class SpawnerBlazeBlock extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:spawner_blaze")
	public static final Block block = null;
	public SpawnerBlazeBlock(EasysurvivalModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SpawnerBlazeUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 100);
		}
	}
