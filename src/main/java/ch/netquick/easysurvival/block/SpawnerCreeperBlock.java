...
public class SpawnerCreeperBlock extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:spawner_creeper")
	public static final Block block = null;
	public SpawnerCreeperBlock(EasysurvivalModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spawner_creeper");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SpawnerCreeperUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 100);
		}
