...
public class SpawnerPillagerBlock extends EasysurvivalModElements.ModElement {
	@ObjectHolder("easysurvival:spawner_pillager")
	public static final Block block = null;
	public SpawnerPillagerBlock(EasysurvivalModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spawner_pillager");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SpawnerPillagerUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 100);
		}
