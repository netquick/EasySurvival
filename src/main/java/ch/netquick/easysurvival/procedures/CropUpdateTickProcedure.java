...
public class CropUpdateTickProcedure extends EasysurvivalModElements.ModElement {
	public CropUpdateTickProcedure(EasysurvivalModElements instance) {
		super(instance, 6);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				EasysurvivalMod.LOGGER.warn("Failed to load dependency x for procedure CropUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				EasysurvivalMod.LOGGER.warn("Failed to load dependency y for procedure CropUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				EasysurvivalMod.LOGGER.warn("Failed to load dependency z for procedure CropUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				EasysurvivalMod.LOGGER.warn("Failed to load dependency world for procedure CropUpdateTick!");
			return;
		}
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(Items.CHORUS_FRUIT, (int) (1)).getItem())) {
			Slotno = (double) 1;
			for (int index6 = 0; index6 < (int) (7); index6++) {
				if (((new Object() {
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) ((Slotno)))) < 64)) {
					{
						...
						if (_ent != null) {
							final int _sltid = (int) ((Slotno));
							final ItemStack _setstack = new ItemStack(Items.POPPED_CHORUS_FRUIT, (int) (1));
							_setstack.setCount((int) ((new Object() {
								public int getAmount(IWorld world, BlockPos pos, int sltid) {
									AtomicInteger _retval = new AtomicInteger(0);
									TileEntity _ent = world.getTileEntity(pos);
